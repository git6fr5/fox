...
public class Input : MonoBehaviour {
    ...
    public Vector2 AttackDirection => m_AttackDirection.normalized;
    ...
    // Climb.
    [SerializeField, ReadOnly] protected bool m_Climb;
    public bool Climb => m_Climb;
    public float ClimbDirection => m_Direction.y;

    // Swimming.
    public Vector2 SwimDirection => m_Direction.normalized;
