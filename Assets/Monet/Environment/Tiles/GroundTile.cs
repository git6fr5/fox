...
namespace Monet {
    ...
    public class GroundTile : Tile {
        ...
        public override void GetTileData(Vector3Int position, ITilemap tilemap, ref TileData tileData) {
            ...
            if (GroundTileEditor.Mapping != null && GroundTileEditor.Mapping.ContainsKey(neighbours.BinaryValue)) {
                tileData.sprite = m_Sprites[GroundTileEditor.Mapping[neighbours.BinaryValue]];
            }
