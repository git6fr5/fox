...
namespace Monet {
    ...
    public class Background : MonoBehaviour {
        ...
        public class BackgroundLayer {
            ...
            public float Height => m_HeightTransform.position.y;
            public float Width => Mathf.Abs(m_HeightTransform.position.x);
            ...
            public BackgroundLayer(Transform transform, Transform heightTransform, float depth, bool perspective) {
                m_Transform = transform;
                m_HeightTransform = heightTransform;
                m_Depth = depth;
        ...
        void Start() {
            ...
            for (int i = 0; i < m_Layers.Length; i++) {
                ...
                Transform leftArm = new GameObject("Left Arm", typeof(SpriteRenderer)).transform;
                ...
                Transform rightArm = new GameObject("Right Arm", typeof(SpriteRenderer)).transform;
                ...
                bkglayers.Add(m_Layers[i]);

                if (m_Layers[i].Shadow) {
                    GameObject shadow = Instantiate(m_Layers[i].Transform.gameObject, m_Layers[i].Transform.position + Vector3.up * 0.25f, Quaternion.identity, m_Layers[i].Transform);
                    shadow.GetComponent<SpriteRenderer>().color = new Color(0.25f, 0.25f, 0.25f, 0.25f);
                    ...
                    bkglayers.Add(new BackgroundLayer(shadow.transform, locator, -10f, m_Layers[i].Perspective));
                }
        ...
        void Update() {
            ...
            for (int i = 0; i < m_Layers.Length; i++) {
                m_Layers[i].Transform.localPosition = new Vector3(m_ParrallaxScale * x * (m_Layers[i].Depth / 100f), m_Layers[i].Transform.localPosition.y, 50f);
            }
